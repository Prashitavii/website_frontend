...
function Homepage(props) {
  return (
    <div className="bg-black text-white preceding-element mb-0">
      <Navbar {...props} />

      <div className="text flex flex-row">
        <div className="text hidden lg:block font-bold mt-16 mx-0">
          <p className="px-10 mx-10 mb-10 text-4xl text-indigo-300">
            Embark On Celestial Journey
          </p>

          <p className="px-10 mx-10 text-4xl mb-10 text-indigo-300">
            Space Talk Star Gazing
          </p>
          <p className="px-10 mx-10 text-4xl mb-10 text-fuchsia-400 underline">
            <Link to="/login">Explore More </Link>
          </p>
        </div>
        <div className="homeImage lg:w-2/3 m-auto">
      ...
      <div className="flex flex-col lg:flex-row border border-gray-700 mx-4 mt-3 mb-3">
        <div className="lg:w-1/2 w-6/7 m-auto">
