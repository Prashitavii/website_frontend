...
//   return (
//    //<nav className="bg-black text-white shadow mont p-1">
        ...
        <div>
          ...
          >
            <ul className=" items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0 text-center">
              ...
              <Link to="/resources">
                <li className=" font-medium text-white-600 hover:text-gray-200 px-1 py-2 flex items-center transition duration-150 ease-in-out">
                  Resources
                </li>
              </Link>
              <Link to="/team">
